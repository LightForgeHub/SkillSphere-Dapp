...
export function CreatorCard({
  ...
  return (
    ...
    >
      {/* Ranking Number */}
      <div className="absolute left-[20px] top-[18px] bg-card rounded-[20px] w-[30px] h-[30px] flex items-center justify-center">
        <p
      ...
      <div className="flex flex-col gap-[5px] items-center w-full">
        <h3 className="font-work font-semibold text-[22px] leading-[1.4] text-foreground text-center capitalize">
          {name}
        </h3>
        <div className="flex gap-[10px] items-center justify-center w-full text-[16px]">
          ...
          <p className="font-mono text-foreground">{totalSales}</p>
        </div>
      </div>
    </div>
  );
...
export function CreatorCardSkeleton() {
  return (
    <div className="bg-gradient-to-b from-[#170f1e] to-[#100817] rounded-[20px] p-[20px] relative flex flex-col items-center gap-[20px] flex-1 min-w-[240px] animate-pulse">
      <div className="absolute left-[20px] top-[18px] bg-card rounded-[20px] w-[30px] h-[30px]" />
      <div className="w-[120px] h-[120px] rounded-full bg-card" />
      <div className="flex flex-col gap-[5px] items-center w-full">
        <div className="h-[30px] bg-card rounded w-[140px]" />
        <div className="h-[22px] bg-card rounded w-[180px]" />
      </div>
    </div>
  );
}
